DESCRIPTION = "Enlightenment DR17 theme for Atto"
LICENSE = "BSD"
LIC_FILES_CHKSUM = "file://${COREBASE}/LICENSE;md5=3f40d7994397109285ec7b81fdeb3b58"

DEPENDS = "edje-native eet-native e-wm places gnome-icon-theme"

PACKAGES_DYNAMIC = "e-wm-config-atto*"
...
python populate_packages_prepend () {
    atto_e_dir = bb.data.expand('${datadir}/enlightenment/data/config', d)
    do_split_packages(d, atto_e_dir, '(.*)', 'e-wm-config-%s', 'E17 window manager %s config', extra_depends='e-wm places gnome-icon-theme', allow_links=True, allow_dirs=True)
}
